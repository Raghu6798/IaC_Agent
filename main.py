...
def main(session_id: str):
    """IaNL — Infrastructure as Natural Language (v0.1.2)
    ...
    if not settings.MISTRAL_API_KEY:
        mistral_key = click.prompt("Enter Mistral API Key,go to https://console.mistral.ai/ to get your API key", hide_input=True)
